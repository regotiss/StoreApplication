...
public class SaleWeek extends JPanel {
	...
	public SaleWeek() {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Reports.getSales(""+(monthsel.getSelectedIndex()+1),(Integer.parseInt(""+comboBox.getSelectedItem())+1));
			}
		});
	...
	public static void create() {
		...
		f.getContentPane().add(new SaleWeek());
